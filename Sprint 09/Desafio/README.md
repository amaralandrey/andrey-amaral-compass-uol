...
Nesta sprint, tivemos o desafio de construir, com os dados da camada Trusted, a camada Refined do nosso data lake referente ao desafio final, com a utilização do AWS Glue e Spark. O desafio era formado por duas etapas.
...
![modelagem-dimensional-versao-1](https://github.com/amaralandrey/andrey-amaral-compass-uol/blob/main/Sprint%2009/Desafio/modelagem-dimensional-versao-1.jpg)

Contudo, ao seguir para a etapa 02, eu não consegui realizar o processamento de dados de duas fontes diferentes seguindo esse modelo, pois o Spark espera que todos os dados lidos em um script sejam consistentes em suas colunas, o que não ocorre com os dados que nos foram passados e os dados que são extraídos da API do TMDB. E eu não consegui solucionar esse problema a tempo.    

Colunas do CSV que nos foi passado:  
...
![modelagem-dimensional-versao-2](https://github.com/amaralandrey/andrey-amaral-compass-uol/blob/main/Sprint%2009/Desafio/modelagem-dimensional-versao-2.jpg)  
...
O código completo está no arquivo "criacao_tabelas_glue.py".
...
O código completo está no arquivo "job-dim-fato-filme.py".
...
O código completo está no arquivo "job-dim-genero.py". 
...
O código completo está no arquivo "job-dim-genero-comb.py". 
